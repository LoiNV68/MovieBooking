              ...
              <div className="col-12">
                <form action="#" className="sign__form sign__form--add">
                  <div className="row">
                        ...
                        <div className="sign__season">
                          <div className="sign__season-head">
                            <div className="row">
                              ...
                              <div className="col-12 col-sm-4 col-md-3 col-xl-2">
                                <button className="sign__btn sign__btn--add">
                          ...
                          <div className="sign__episode">
                            <div className="row">
                              ...
                              <div className="col-12">
                                <div className="sign__video">
                                  <label id="s1s1" htmlFor="sign__video-upload1">
                                    Upload episode 1
                                  </label>
                                  <input
                                    data-name="#s1s1"
                                    id="sign__video-upload1"
                                    name="s1s1"
                                    className="sign__video-upload"
                                    type="file"
                                    accept="video/mp4,video/x-m4v,video/*"
                          ...
                          <div className="sign__episode">
                            <div className="row">
                              ...
                              <div className="col-12 col-sm-8 col-md-9 col-xl-10">
                                <div className="sign__video">
                                  <label id="s1s2" htmlFor="sign__video-upload2">
                                    Upload episode 2
                                  </label>
                                  <input
                                    data-name="#s1s2"
                                    id="sign__video-upload2"
                                    name="s1s2"
                                    className="sign__video-upload"
                                    type="file"
                                    accept="video/mp4,video/x-m4v,video/*"
                    ...
                    {/* end tv series */}
                    <div className="col-12">
                      <button type="button" className="sign__btn sign__btn--small">
                        <span>Publish</span>
                      </button>
                    </div>
                  </div>
